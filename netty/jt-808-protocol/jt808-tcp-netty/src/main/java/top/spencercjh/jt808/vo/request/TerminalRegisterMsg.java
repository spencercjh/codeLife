package top.spencercjh.jt808.vo.request;
...
public class TerminalRegisterMsg extends PackageData {
    ...
    public boolean equals(Object o) {
        ...
        TerminalRegisterMsg that = (TerminalRegisterMsg) o;
        return Objects.equals(terminalRegInfo, that.terminalRegInfo);
    }

    @Override
    public int hashCode() {
        return Objects.hash(super.hashCode(), terminalRegInfo);
    }
    ...
    public static class TerminalRegInfo {
        ...
        public boolean equals(Object o) {
            ...
            TerminalRegInfo that = (TerminalRegInfo) o;
            return provinceId == that.provinceId &&
                    cityId == that.cityId &&
                    licensePlateColor == that.licensePlateColor &&
        ...
        @Override
        public int hashCode() {
            return Objects.hash(provinceId, cityId, manufacturerId, terminalType, terminalId, licensePlateColor, licensePlate);
        }
    }
}
