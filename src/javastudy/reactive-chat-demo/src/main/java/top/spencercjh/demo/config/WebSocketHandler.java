...
public class WebSocketHandler extends SimpleChannelInboundHandler<Object> {
    ...
    public void channelActive(ChannelHandlerContext ctx) {
        CustomNettyWebServerFactory.CHANNEL_GROUP.add(ctx.channel());
    }
    ...
    public void channelInactive(ChannelHandlerContext ctx) {
        ...
        CustomNettyWebServerFactory.CHANNEL_GROUP.remove(ctx.channel());
    }
    ...
    private void handleWebSocketMessage(ChannelHandlerContext ctx, WebSocketFrame msg) {
        ...
        if (msg instanceof PingWebSocketFrame) {
            ...
            CustomNettyWebServerFactory.CHANNEL_GROUP.writeAndFlush(new TextWebSocketFrame(new Date().toString()));
        }
    }
    ...
    private void broadcastWsMsg(ChannelHandlerContext ctx, WebSocketMessage msg) {
        CustomNettyWebServerFactory.CHANNEL_GROUP.stream()
